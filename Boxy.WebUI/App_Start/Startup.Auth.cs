...
namespace Boxy.WebUI
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            {
                ClientId = "161356578430-lb035kh2u6fo0dt0l8as59oim59k0khi.apps.googleusercontent.com",
                ClientSecret = "P8pK2utar7mJMlETEMfi40Cc",
                Caption = "fa fa-google"
            });
            app.UseVkontakteAuthentication(new Duke.Owin.VkontakteMiddleware.VkAuthenticationOptions()
            {
                AppId = "6348609",
                AppSecret = "UDgxkpJGjnLejUaYigt9",
                Caption = "fa fa-vk",
            });
        }
    }
